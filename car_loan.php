...
<script>
	...
	function carCalculatePayment() {
		  $.ajax({
			   type: "post",
			   url: '../child/CarLoanCalculate.php',
...
<div class="container">
	...
	<div class="col-md-4 col-md-offset-4">
		<button type="button" class="btn btn-default" style="width:100%; background:#eee;" onclick="carCalculatePayment()">Calculate</button>
	</div>
